...
import amazfit.deadreckoning.activity.GraphActivity;
...
public class SensorCalibrationDialogFragment extends DialogFragment {
    ...
    private void startCalibrationDialogs() {
        ...
        magCalibrateDialog.setHandler(new SensorCalibrationHandler(getActivity(), getDialog(), magCalibrateDialog));
    ...
    private static class SensorCalibrationHandler extends Handler {
        ...
        SensorCalibrationHandler(Context context, Dialog dialog, MagCalibrationDialogFragment magCalibrateDialog) {
